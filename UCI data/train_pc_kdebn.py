...
def run_pc_lc_kdebn(result_folder, idx_fold):
...
def run_pc_kdebn(result_folder, idx_fold):
    run_pc_lc_kdebn(result_folder, idx_fold)
    run_pc_rcot_kdebn(result_folder, idx_fold)
