...
def compare_models(true_model, dataset_name, num_instances):
    ...
    for i in range(experiments_helper.NUM_SIMULATIONS):
        ...
        gbn_bic_folder = 'models/' + dataset_name + '/' + str(i).zfill(3) + '/' + str(num_instances) + '/HillClimbing/GBN_BIC/'
    ...
    for i in range(experiments_helper.NUM_SIMULATIONS):
        ...
        gbn_bge_folder = 'models/' + dataset_name + '/' + str(i).zfill(3) + '/' + str(num_instances) + '/HillClimbing/GBN_BGe/'
