...
def compare_models(true_model, dataset_name, num_instances):
    ...
    for p in experiments_helper.PATIENCE:
        for i in range(experiments_helper.NUM_SIMULATIONS):
            ...
            spbn_ckde_lc_folder = 'models/' + dataset_name + '/' + str(i).zfill(3) + '/' + str(num_instances) + '/PC/SPBN_CKDE/LinearCorrelation/' + str(p)
        ...
        print("Mean SPBN CKDE patience " + str(p) + " LinearCorrelation results: ")
        ...
        for i in range(experiments_helper.NUM_SIMULATIONS):
            ...
            spbn_ckde_rcot_folder = 'models/' + dataset_name + '/' + str(i).zfill(3) + '/' + str(num_instances) + '/PC/SPBN_CKDE/RCoT/' + str(p)
        ...
        print("Mean SPBN CKDE patience " + str(p) + " RCoT results: ")
        print("Loglik: " + str(ll.mean()))
        print("SHD: " + str(shd.mean()))
        print("Hamming: " + str(hamming.mean()))
        print()
